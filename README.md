...
Step 1
The user begins by interacting with the UI to select a suite of pre-built tests. They are required to enter general information about the proxy such as the Proxy URL. These tests require the user to input specific 
Step 1
